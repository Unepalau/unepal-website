...
export default function Hero() {
  return (
    <section
      id="home"
      className="relative isolate overflow-hidden bg-[#F8FAFC] pt-24 text-[#071632] sm:pt-28 lg:pt-32"
    >
        ...
        <div className="mx-auto grid max-w-6xl gap-8">
          <FadeIn className="hero-copy mx-auto max-w-5xl text-center">
            ...
            <p className="mx-auto mt-6 max-w-3xl text-base font-semibold leading-7 text-[#65676B] sm:text-lg sm:leading-8">
              Connect with your community, share posts, discover local updates,
              find rooms, jobs, services, events, businesses, videos, and more
              in one app.
            </p>
            ...
            <div className="hero-cta-row mt-7 justify-center">
              <a
                ...
                className="hero-cta-badge store-badge store-badge--android store-badge--large justify-center"
              >
              ...
              <a
                ...
                className="hero-cta-badge store-badge store-badge--ios store-badge--large justify-center"
              >
            ...
            <a
              href="#features"
              className="mt-4 inline-flex min-h-11 items-center justify-center gap-2 rounded-full border border-[#E4E6EB] bg-white px-4 py-2 text-sm font-extrabold text-[#071632] shadow-sm hover:text-brand-primary"
            >
              Explore features
          ...
          <FadeIn delay={0.1} className="mx-auto mt-6 w-full max-w-5xl">
            <p className="mb-3 text-center text-xs font-bold uppercase tracking-[0.14em] text-[#65676B]">
