      ...
      >
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="flex items-center justify-between gap-4">
            <Link
              href="/"
              className="logo-lockup min-h-11"
              aria-label="uNepal home"
            >
              ...
              <div className="logo-stack">
                <span className="text-lg font-extrabold leading-none text-brand-primary sm:text-xl">
                  uNepal
                </span>
                <span className="mt-1 text-[10px] font-bold text-[#65676B] sm:text-[11px]">
            ...
            >
              {navItems.map(([label, href]) => (
                <Link
                  key={label}
                  href={href}
                  className="inline-flex min-h-11 items-center rounded-xl px-3 py-2 text-sm font-extrabold text-[#071632]/72 transition hover:bg-[#FFF2F4] hover:text-brand-primary"
                >
                  {label}
                </Link>
              ))}
            ...
            <button
              ...
              className="focus-ring inline-flex h-11 w-11 items-center justify-center rounded-xl border border-[#E4E6EB] bg-white text-[#071632] shadow-sm transition hover:bg-[#FFF2F4] lg:hidden"
          ...
          {isMenuOpen && (
            <div
              ...
              className="absolute left-0 right-0 top-full overflow-hidden border-t border-[#E4E6EB] bg-white shadow-2xl lg:hidden"
            >
              <div className="container mx-auto grid gap-1 px-4 py-3">
                {navItems.map(([label, href]) => (
                  <Link
                    ...
                    href={href}
                    onClick={() => setIsMenuOpen(false)}
                    className="flex min-h-11 items-center justify-between rounded-xl border border-transparent px-3 py-2.5 text-sm font-extrabold text-[#071632] hover:border-[#E4E6EB] hover:bg-[#F8FAFC]"
                  >
