    ...
    <section id="download" className="section bg-[#F7F4EE]">
      <div className="site-shell">
        <div className="download-stage">
          <div>
            <span className="eyebrow">uNepal 5.0.5</span>
            ...
            <p className="mt-6 max-w-2xl text-base font-medium leading-8 text-[#65676B] sm:text-lg">Android 5.0.5 is live now. iOS 5.0.5 is currently Waiting for Review.</p>
          ...
          <div className="download-statuses" aria-label="App availability">
            ...
            <Link href="/download" className="text-center text-xs font-bold text-[#65676B] underline decoration-[#E60023]/25 underline-offset-4 hover:text-[#E60023]">Download options and status</Link>
          </div>
        </div>
      </div>
    </section>
